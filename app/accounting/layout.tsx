...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/accounting/integrity-seals", label: "Sellos de Integridad" },
      { href: "/accounting/arbitrage-detection", label: "Detector de Arbitraje Cambiario" },
      { href: "/accounting/due-diligence", label: "Debida Diligencia" },
      { href: "/accounting/blockchain-reconciliation", label: "Conciliacion Blockchain" },
