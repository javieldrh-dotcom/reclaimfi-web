...
export default function TecnologiaPage() {
  ...
  const isWideScript = ["ja", "ko", "zh", "zh-TW", "ru"].includes(locale);
  const cardTitleSize = isWideScript ? 19 : 26;
    ...
    <div style={{ background: "radial-gradient(ellipse 90% 50% at 50% -10%, " + bgCard + " 0%, " + bg + " 60%, #040911 100%)", minHeight: "100vh", color: ink, fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "22px 48px", borderBottom: "1px solid " + cardBorder, flexWrap: "wrap", gap: 16, background: "rgba(10,22,40,0.85)", backdropFilter: "blur(12px)", position: "sticky", top: 0, zIndex: 50 }}>
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: 28, flexWrap: "wrap" }}>
          ...
          <Link href={"/" + locale + "/servicios"} style={{ color: ink, textDecoration: "none", fontSize: 19, fontWeight: 600 }}>{tNav("servicios")}</Link>
          <Link href={"/" + locale + "/tecnologia"} style={{ color: sky, textDecoration: "none", fontSize: 19, fontWeight: 700 }}>{tNav("tecnologia")}</Link>
      ...
      <section style={{ padding: "20px 40px 90px", maxWidth: 1150, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 26 }}>
          <div style={featureCard}>
            ...
            <h2 style={{ fontSize: cardTitleSize, fontWeight: 800, overflowWrap: "break-word", wordBreak: "break-word" }}>{t("feature1Title")}</h2>
          ...
          <div style={featureCard}>
            ...
            <h2 style={{ fontSize: cardTitleSize, fontWeight: 800, overflowWrap: "break-word", wordBreak: "break-word" }}>{t("feature2Title")}</h2>
          ...
          <div style={featureCard}>
            ...
            <h2 style={{ fontSize: cardTitleSize, fontWeight: 800, overflowWrap: "break-word", wordBreak: "break-word" }}>{t("feature3Title")}</h2>
          ...
          <div style={featureCard}>
            ...
            <h2 style={{ fontSize: cardTitleSize, fontWeight: 800, overflowWrap: "break-word", wordBreak: "break-word" }}>{t("feature4Title")}</h2>
          ...
          <div style={featureCard}>
            ...
            <h2 style={{ fontSize: cardTitleSize, fontWeight: 800, overflowWrap: "break-word", wordBreak: "break-word" }}>{t("feature5Title")}</h2>
          ...
          <div style={featureCard}>
            ...
            <h2 style={{ fontSize: cardTitleSize, fontWeight: 800, overflowWrap: "break-word", wordBreak: "break-word" }}>{t("feature6Title")}</h2>
