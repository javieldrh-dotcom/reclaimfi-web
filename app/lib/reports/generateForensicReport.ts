...
export function generateForensicReport(
  ...
  doc.setFontSize(13);
  doc.setFont("helvetica", "bold");
  doc.text("3. Historial de Auditoria", 15, y);
  y += 8;
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text(
      "Este reporte documenta el proceso de investigacion y la evidencia recopilada. No constituye garantia de recuperacion de fondos.",
      pageWidth / 2,
      290,
